...
export default function TransactionsAnalysis() {
 const {monthKey}=useMonth(); const navigate=useNavigate();
 const expensesRes=useAsync(()=>listExpenses(monthKey),[monthKey]);
 const incomesRes=useAsync(()=>listIncomes(monthKey),[monthKey]);
