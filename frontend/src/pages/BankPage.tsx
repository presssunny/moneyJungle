    ...
    >
      ...
      <Card title={selected ? `ייבוא דף חשבון — ${selected.accountName}` : "ייבוא דף חשבון (עו״ש)"}>
        ...
        <DropZone
          ...
          hint={
            selected
              ? `הכנסות (זכות) והוצאות (חובה) יתווספו לחשבון "${selected.accountName}", ההוצאות יסווגו לקטגוריות, ותנועות שכבר קיימות לא יתווספו שוב. בקובץ PDF כדאי לעבור על התנועות אחרי ההעלאה`
